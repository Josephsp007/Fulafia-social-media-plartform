...
<head>
  ...
  <title>Add Student | FULAFIA</title>
      ...
      <div class="card card-warning card-outline mb-4 col-md-6 m-auto">
                  ...
                  <form>
                    ...
                    <div class="card-footer">
                      <button type="submit" id="addStudent" class="btn btn-primary">
                        <span>Add</span>
                    </button>
...
$(document).ready(function(){
    ...
    $("#addStudent").click(function(e){
      ...
      $.ajax({
        type: 'POST',
        url: 'function.php',
        data: {name:name, email:email,nick:nick, ids:ids, password:password, type:type},
        beforeSend: function(){
          $('.btn').html("Adding");
