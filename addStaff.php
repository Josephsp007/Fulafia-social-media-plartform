  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card card-warning card-outline mb-4 col-md-6 m-auto">
                  <!--begin::Header-->
                  <div class="card-header"><div class="card-title">Add New Staff</div></div>
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form>
                    ...
                    <div class="card-body row-12">
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-11">
                          <input type="text" autofocus name="name" id="name" class="form-control" value="<?php if(isset($_POST["name"])){echo $_POST["name"];}?>">
                        </div>
                      </div>
                      <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        <label for="inputEmail3" class="ml-2">Matric No</label>
                        <div class="col-sm-11">
                          <input type="text" class="form-control" name="ids" id="ids" value="<?php if(isset($_POST["ids"])){echo $_POST["ids"];}?>">
                        </div>
                      </div>
                      <div class="row mb-3">
                    ...
                    <div class="card-footer">
                      <button type="submit" id="addStaff" class="btn btn-primary">
                        <span>Add</span>
                    </button>
...
$(document).ready(function(){
    ...
    $("#addStaff").click(function(e){
      ...
      $.ajax({
        type: 'POST',
        url: 'function.php',
        data: {name:name, email:email, ids:ids, password:password, type:type},
        beforeSend: function(){
          $('.btn').html("Adding");
