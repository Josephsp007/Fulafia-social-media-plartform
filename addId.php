  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2 my-4 mx-auto">
          <div class="col-sm-6 m-auto">
            <h1>Add Matric No / Staff ID</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
              <li class="breadcrumb-item active">New Matric No / Staff ID</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card card-warning card-outline mb-4 col-md-6 m-auto">
                  <!--begin::Header-->
                  <div class="card-header"><div class="card-title">Add Matric No / Staff ID</div></div>
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form>
                    ...
                    <div class="card-body row-12">
                      ...
                      <div class="row mb-3">
                        <label for="name" class="ml-2">Enter new ID.</label>
                        <div class="col-sm-11">
                          <input type="text" autofocus name="nick" id="mat" class="form-control" value="<?php if(isset($_POST["ids"])){echo $_POST["ids"];}?>">
                        </div>
                      </div>
                      </div>
                      <div class="row mb-3">
                    ...
                    <div class="card-footer">
                      <button type="submit" id="addId" class="btn btn-primary">
                        <span>Add</span>
                    </button>
